    ...
    return [
      {
        ...
        headers: [
          ...
          },
          {
            ...
            value: [
              "default-src 'self'",
              "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://www.googletagmanager.com https://plausible.io https://embed.tawk.to https://va.tawk.to",
              ...
              "connect-src 'self' https://www.google-analytics.com https://plausible.io https://embed.tawk.to https://va.tawk.to wss://*.tawk.to",
