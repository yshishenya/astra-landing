...
export const CASE_STUDIES = [
  {
    ...
    challenge: {
      title: 'Ситуация',
      description:
        'Разработчик с 3 годами опыта просит повышение, но совершенно не подходит для мидл-позиции.',
      problem:
        'HR часами совещается с техлидами и менеджерами, не зная, как корректно отказать и при этом удержать таланта.',
    },
    solution: {
      title: 'Решение с Astra',
      steps: [
        'Астра анализирует резюме и показывает текущие сильные стороны',
        'Выявляет, что нужно развивать ещё 6-12 месяцев для перехода на мидл',
        'Создает реалистичный план с конкретными проектами',
        'Предлагает альтернативный путь: специализированная роль без управления',
      ],
      timeline: '90 секунд анализа + 30 минут обсуждения с сотрудником',
    },
    results: {
      title: 'Результаты',
      description:
        'Сотрудник понял свой путь развития, увидел конкретный план и остался в компании вместо поиска работы вовне.',
      metrics: [
        { label: 'Удержание таланта', value: '+1 специалист', highlight: true },
        { label: 'Время HR', value: '4 часа сэкономлено' },
        { label: 'Избежано затрат', value: '250,000 ₽' },
      ],
    },
    testimonial: {
      quote:
        'Раньше такие разговоры были болезненными и часто заканчивались уходом сотрудника. Теперь у нас есть конкретный план, и люди видят, что мы действительно хотим их развивать.',
      author: 'Екатерина Смирнова',
      role: 'HR Director',
      avatar: '/images/testimonials/ekaterina.jpg',
    },
    image: '/images/case-studies/developer-career.jpg',
    tags: ['Удержание', 'Развитие', 'IT'],
  },
  {
    id: 'finance-internal-promotion',
    ...
    challenge: {
      title: 'Ситуация',
      description:
        'Начальник отдела уходит, нужно найти замену внутри компании. Но кто готов? Неясно.',
      problem:
        'Ручной поиск и интервьюирование 5-10 кандидатов = 2-3 недели. Неэффективный процесс, можем пропустить лучшего кандидата.',
    },
    solution: {
      title: 'Решение с Astra',
      steps: [
        'Астра быстро анализирует резюме 5-10 потенциальных кандидатов',
        'Выделяет лучших по компетенциям для руководящей роли',
        'Показывает, какие зоны развития нужно подтянуть',
        'Генерирует ИПР для ускоренной подготовки выбранного кандидата',
      ],
      timeline: '10 анализов за 15 минут + 1 день на решение',
    },
    results: {
      title: 'Результаты',
      description:
        'Решение принято за 1-2 дня вместо 2-3 недель. Внутренний наем на 100%, избежали дорогостоящего внешнего рекрутинга.',
      metrics: [
        { label: 'Время решения', value: '2 недели → 2 дня', highlight: true },
        { label: 'Внутренний наем', value: '100%' },
        { label: 'Избежано затрат', value: '500,000 ₽' },
      ],
    },
    testimonial: {
      quote:
        'ROI был простой: мы сэкономили 500 тысяч рублей на рекрутинге и получили готового кандидата за 2 дня. Для CFO это no-brainer решение.',
      author: 'Алексей Петров',
      role: 'CFO',
      avatar: '/images/testimonials/alexey.jpg',
    },
    image: '/images/case-studies/internal-promotion.jpg',
    tags: ['Внутренний наем', 'Лидерство', 'Финансы'],
  },
  {
    id: 'retail-mass-development',
    ...
    challenge: {
      title: 'Ситуация',
      description:
        'Компания из 300 человек хочет создать культуру развития. Нужны планы развития для каждого, но ресурсов нет.',
      problem:
        'Нанять 3 коучей на такую задачу = 500k-1M в год. Ручной анализ: 1-2 человека в день = 150-300 дней работы.',
    },
    solution: {
      title: 'Решение с Astra',
      steps: [
        'Один HR-специалист загружает все резюме в Astra',
        'Запускает массовый анализ для 300 сотрудников',
        'Получает индивидуальные отчёты с рекомендациями для каждого',
        'Обсуждает с менеджерами уточнения и адаптирует планы',
      ],
      timeline: '2 недели работы одного HR вместо 10 месяцев',
    },
    results: {
      title: 'Результаты',
      description:
        'Культура развития запущена в масштабе всей компании. Удержание талантов выросло, затраты на 80% ниже альтернатив.',
      metrics: [
        { label: 'Проанализировано', value: '300 сотрудников', highlight: true },
        { label: 'Затрачено времени', value: '2 недели' },
        { label: 'Экономия', value: '800,000 ₽' },
      ],
    },
    testimonial: {
      quote:
        'Мы провели 300 анализов в течение двух недель. Раньше это было бы невозможно. Текучка упала на 12%, внутренний наем вырос на 20%.',
      author: 'Мария Сидорова',
      role: 'HR Director',
      avatar: '/images/testimonials/maria.jpg',
    },
    image: '/images/case-studies/mass-development.jpg',
    tags: ['Масштаб', 'Культура', 'Ритейл'],
  },
] as const;

export const CASE_STUDIES_PAGE = {
  meta: {
    title: 'Кейсы клиентов — Astra',
    description:
      'Реальные истории успеха: как компании используют Astra для развития сотрудников, снижения текучести и повышения вовлеченности.',
  },
  hero: {
    headline: 'Как компании трансформируют HR с Astra',
    subheadline:
      'Реальные кейсы от технологических, финансовых и ритейл-компаний. Узнайте, как AI-карьерный помощник решает проблемы удержания талантов и развития сотрудников.',
  },
  stats: {
    title: 'Общие результаты клиентов',
    metrics: [
      { label: 'Компаний используют', value: '120+' },
      { label: 'Сотрудников проанализировано', value: '5000+' },
      { label: 'Средний ROI', value: '162x' },
      { label: 'Снижение текучести', value: '-23%' },
    ],
  },
  cta: {
    headline: 'Готовы получить похожие результаты?',
    subheadline: 'Начните с бесплатного пилота и увидите результаты за первую неделю',
